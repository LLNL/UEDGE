...
ftol_dt 	real /1.e-4/	# fnrm tolerance for the time-dependent steps
...
irev  		integer /-1/	# flag to allow reduced dt advance after cutback
...
up(0:nx+1,0:ny+1,1:nisp)   _real  [m/s]   #parallel ion velocity (mass-dens.
                                          # avg if isimpon = 5)
upi(0:nx+1,0:ny+1,1:nisp)  _real  [m/s]   #parallel ion velocity 
...
***** Ident_vars:
uedge_ver character*80 /'$Name: V7_06 $'/
