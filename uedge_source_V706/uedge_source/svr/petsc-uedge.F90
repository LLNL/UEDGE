...
! ---------------------------------------------------------------------
      ...
      character*75,   INTENT(OUT)   :: jac_rebuild_output
      PetscErrorCode, INTENT(OUT)   :: ierr
...
! ---------------------------------------------------------------------
      ...
      PetscInt     :: rebuild
      KSP          :: ksp
      character*75 :: jac_rebuild_output
