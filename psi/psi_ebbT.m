...
c*/
      ...
      double precision function psiebbgf(g)
      implicit none
      double precision g
      double precision f
      ...
      double precision function psiebbtf(t,tm)
      implicit none
      ...
      double precision function psiebbt(iz,t)
      implicit none
      integer iz
      double precision t
c
...
c
      ...
      double precision psi_eBB,psieBBgf,psieBBtf,psi_Tsub
