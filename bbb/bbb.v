...
fngyteleout(0:nx+1,ngspmx)              _real      +threadprivate # flux of tele-transport neutral going out of the outer boundary,
fngytelein(0:nx+1,ngspmx)               _real      +threadprivate # flux of tele-transport neutral coming back into the outer boundary,
	                                           # = fngyteleout*cftelematrix
fngytelemaxw(0:nx+1,ngspmx)             _real      +threadprivate # flux of tele-transport neutral going out of the outer boundary, assuming half-Maxw
fngytelediff(0:nx+1,ngspmx)             _real      +threadprivate # flux of tele-transport neutral going out of the outer boundary, assuming CX diffusion
...
fngytelediff1(0:nx+1,ngspmx)            _real     +threadprivate # first component of fngytelediff
fngytelediff2(0:nx+1,ngspmx)            _real     +threadprivate # second component of fngytelediff
fngytelediff3(0:nx+1,ngspmx)            _real     +threadprivate # third component of fngytelediff
fngytelediff30(0:nx+1,ngspmx)           _real     +threadprivate # third component of fngytelediff before applying limiter
...
Kn(0:nx+1,ngspmx)                       _real     +threadprivate # Knusen number at the outer boundary, = lmfpn/lteleout, where lmfpn = sqrt(Tg/mg)/nucx
...
fmgyteleout(0:nx+1,ngsp)                _real    +threadprivate # mom. flux of tele-transport neutral going out of the outer boundary,
fmgytelein(0:nx+1,ngsp)                 _real    +threadprivate # mom. flux of tele-transport neutral coming back into the outer boundary,
                                      # = 0. for current model, assuming wall absorb all the mom. and energy
fmgytelemaxw(0:nx+1,ngsp)               _real    +threadprivate # mom. flux of tele-transport neutral going out of the outer boundary, assuming half-Maxw
                                      # fegytelemaxw = fngytelemaxw*mu_p
fmgytelediff(0:nx+1,ngsp)               _real    +threadprivate # mom. flux of tele-transport neutral going out of the outer boundary, assuming CX diffusion
...
fmgytelediff1(0:nx+1,ngsp)  _real     +threadprivate # first component of fmgytelediff
fmgytelediff2(0:nx+1,ngsp)  _real     +threadprivate # second component of fmgytelediff
fmgytelediff3(0:nx+1,ngsp)  _real     +threadprivate # third component of fmgytelediff
fegyteleout(0:nx+1,ngsp)    _real     +threadprivate # eng. flux of tele-transport neutral going out of the outer boundary,
fegytelein(0:nx+1,ngsp)     _real     +threadprivate # eng. flux of tele-transport neutral coming back into the outer boundary,
                                      # = 0. for current model, assuming wall absorb all the mom. and energy
fegytelemaxw(0:nx+1,ngsp)   _real     +threadprivate # eng. flux of tele-transport neutral going out of the outer boundary, assuming half-Maxw
                                      # fegytelemaxw = fngytelemaxw*(0.5mu_p^2 + 2T), omit 0.5mu_p^2 for internal
fegytelediff(0:nx+1,ngsp)   _real     +threadprivate # eng. flux of tele-transport neutral going out of the outer boundary, assuming CX diffusion
...
fegytelediff1(0:nx+1,ngsp)  _real     +threadprivate # first component of fegytelediff
fegytelediff2(0:nx+1,ngsp)  _real     +threadprivate # second component of fegytelediff
fegytelediff3(0:nx+1,ngsp)  _real     +threadprivate # third component of fegytelediff
